var iBox = function() {
		...
		var create = function(elem) {
				...
				if (!_pub.is_firefox) {
					...
					els.overlay.style.backgroundImage = "url('" + _pub.base_url + "../img/bg.png')"
				}
		...
		var drawCSS = function() {
				var core_styles = "#ibox {z-index:1000000;text-align:left;} #ibox_overlay {z-index:1000000;} #ibox_loading {position:absolute;z-index:1000001;} #ibox_wrapper {position:absolute;top:0;left:0;z-index:1000001;} #ibox_content {z-index:1000002;margin:27px 5px 5px 5px;padding:2px;} #ibox_content object {display:block;} #ibox_content .ibox_image {width:100%;height:100%;margin:0;padding:0;border:0;display:block;} #ibox_footer_wrapper a {float:right;display:block;outline:0;margin:0;padding:0;} #ibox_footer_wrapper {text-align:left;position:absolute;top:5px;right:5px;left:5px;white-space:nowrap;overflow:hidden;}";
				var default_skin = "#ibox_footer_wrapper {font-weight:bold;height:20px;line-height:20px;} #ibox_footer_wrapper a {text-decoration:none;padding:0 5px;color:#000;font-weight:bold;font-family:Arial,sans-serif;font-size:16px;} #ibox_footer_wrapper a:hover {color:#0e80c8;} #ibox_footer_wrapper {font-size:12px;font-family:Verdana, Arial, Helvetica, sans-serif;color:#111;width:60px;height:30px;margin:287px 0 0 118px;padding:10px 5px 0 0;border: 1px solid;border-radius: 5px 5px 5px 5px; background: -moz-linear-gradient(top,  #fcfeff 0%, #dae4e8 74%, #bad3db 100%);background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#fcfeff), color-stop(74%,#dae4e8), color-stop(100%,#bad3db));background: -webkit-linear-gradient(top,  #fcfeff 0%,#dae4e8 74%,#bad3db 100%);background: -o-linear-gradient(top,  #fcfeff 0%,#dae4e8 74%,#bad3db 100%);background: -ms-linear-gradient(top,  #fcfeff 0%,#dae4e8 74%,#bad3db 100%);background: linear-gradient(to bottom,  #fcfeff 0%,#dae4e8 74%,#bad3db 100%);filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#fcfeff', endColorstr='#bad3db',GradientType=0 );} #ibox_loading {padding:50px; background:#000;color:#fff;font-size:16px;font-weight:bold;}";
